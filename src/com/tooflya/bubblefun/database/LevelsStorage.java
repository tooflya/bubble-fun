...
public class LevelsStorage extends SQLiteOpenHelper {
	...
	public int updateLevel(final int id, final int pOpen, final int pStars) {
		...
		return db.update(TABLE, values, ID + " = ?", new String[] { String.valueOf(id + 25 * Options.boxNumber) });
	}
	...
	public Level getLevel(int id) {
		...
		Cursor cursor = db.query(TABLE, new String[] { STATE, STARS }, ID + "=?", new String[] { String.valueOf(id + 25 * Options.boxNumber) }, null, null, null, null);
